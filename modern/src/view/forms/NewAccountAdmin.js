Ext.define('Admin.view.forms.Account', {
    ...
    xtype: 'newaccountadminform',
    cls: "wizardform",
    title: "Crear Administrador",
    itemId: 'newaccountadminform',
	id: 'newaccountadminform',
...
(this.getParent().down('#secondlastname').getValue()) ? '' : this.getParent().down('#secondlastname').setPlaceHolder('ingresa el segundo apellido');
			 ...
			 data = { firstname: Ext.util.Format.lowercase(firstname), 
				 ...
				 Ext.Msg.confirm("Crear Administrador", "Estas a punto de crear el usuario Administrador: " + ' ' + '<b>' + this.getParent().down('#user').getValue() + '</b>' + ' ' + this.getParent().down('#firstname').getValue() + ' ' +  this.getParent().down('#firstlastname').getValue() + ' ' + this.getParent().down('#secondlastname').getValue() +  " ,deseas continuar?", function(btn){ 
			                                                        if(btn === 'yes'){
			Ext.websocket.send('newaccountadmon',  { data: { firstname: data.firstname,
